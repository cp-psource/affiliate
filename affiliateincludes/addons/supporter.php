        ...
        <div class="inside">
			<?php
				...
				if ($prosites_currency != $affiliate_currency) {
					?><p class="error"><?php echo sprintf(__('Währungsinkongruenz. Deine Bloghosting-Währung ist auf <strong>%s</strong> festgelegt, die Währung des Partnerprogramms jedoch auf <strong>%s</strong>. Bitte stelle sicher, dass beide richtig eingestellt sind.'), $prosites_currency, $affiliate_currency) ?></p><?php
				}
			?>

          <table class="form-table">
            <tr valign="top">
            <th scope="row"><?php _e('1 Monat Zahlung', 'affiliate'); ?></th>
            <td>
		        ...
		        <br /><?php _e('Partnerprogramm Zahlung für einen Monat.'); ?>
            </td>
            </tr>

			<tr valign="top">
            <th scope="row"><?php _e('3 Monate Zahlung', 'affiliate'); ?></th>
            <td>
		        ...
		        <br /><?php _e('Partnerprogramm Zahlung für drei Monate.'); ?>
            </td>
            </tr>

			<tr valign="top">
            <th scope="row"><?php _e('12 Monate Zahlung', 'affiliate'); ?></th>
            <td>
	            ...
	            ?>
		        <br /><?php _e('Partnerprogramm Zahlung für zwölf Monate.'); ?>
            </td>
            </tr>
...
/**
 * Adds the Partnerprogramm setting tab to ProSites settings.
 *
 * @param $tabs
 *
 * @return mixed
...
function affiliate_supporter_settings_tabs( $tabs ) {
	...
	$tabs['affiliate'] = array(
		'title' => __( 'Partnerprogramm Einstellungen', 'affiliate' ),
		'desc'               => array(
			__( 'Einstellungen des Partnerprogramm-Plugins zur Aufzeichnung von ProSite-Zahlungen', 'psts' ),
		),
